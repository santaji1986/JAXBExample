...
import generated.ContactInformation;
import generated.EmailAddress;
import generated.FormData;
import generated.PersonDetails;
...
public class TestMain {
	public static void main(String[] args) {
		...
		System.out.println(emailAddress.getEmailAddress() + " : " + emailAddress.getCellPhone() + " : "
				+ emailAddress.getLanguage());
	}
